%G	;M Utility;Standard SCA global display
	...
	;
	;-----Revision History-------------------------------------------------
	; 09/26/08 - Manoj Thoniyil
	;            Modified QUOTES section to handle control characters in subscripts. 
	;
...
QUOTES	; Put double quotes back in
	...
	E  D
	. I %GS(%GS)'?.E1C.E D  Q
	.. S %G=%G_""""_%GS(%GS)_"""" ; String has control character(s)
	. N XI,%GSN,%GSX,CP,CN
	. S %GSN=""
	. S CN=$E(%GS(%GS))?1C
	. S %GSN=$S(CN:"$C("_$A($E(%GS(%GS),1)),1:""""_$E(%GS(%GS)))
	. S CP=CN
	. F XI=2:1:$L(%GS(%GS)) D
	.. S %GSX=$E(%GS(%GS),XI)
	.. S CN=%GSX?1C
	.. ; pre: we need to decide on one of the following 4: <null> "_$C( )_" ,
	.. S %GSN=%GSN_$S((CP&CN):",",(CN&'CP):"""_$C(",(CP&'CN):")_""",1:"")
	.. ; the char:
	.. S %GSN=%GSN_$S(CN:$A(%GSX),1:%GSX)
	.. S CP=CN
	. I CN S %GSN=%GSN_")" ; last char was a control char
	. I 'CN S %GSN=%GSN_"""" ; last char was not a control char
	. S %G=%G_%GSN
	Q
	;
