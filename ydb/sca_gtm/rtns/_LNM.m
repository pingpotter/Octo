%LNM	
	...
	;	* Modified CDIR() to call CDIR^%TRNLNM()
	;
	;----------------------------------------------------------------------
...
CDIR(FILENAME)	;Get the absolute value of the defined current directory
	;----------------------------------------------------------------------
	IF $DATA(FILENAME) QUIT $$CDIR^%TRNLNM(FILENAME)	; file in current working directory
	QUIT $$CDIR^%TRNLNM()					; just the current working directory
	;
	;----------------------------------------------------------------------
