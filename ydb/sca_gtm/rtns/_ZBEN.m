%ZBEN(par,input)	;Library;Benchmark Utilities
	...
	;---- Revision History ------------------------------------------------
	;
	; 07/11/07 - BECKERJ - 10765
	;	     The GETJPI^%ZFUNC does not exist in the unix version of 
	;	     %ZFUNC.  Remove the line of code where the call existed
	;	     in PROC.  Replaced the call with "" in sections CPUTIM,
	;	     BUFIO and DIRIO.
	;		 
	;----------------------------------------------------------------------
	;
