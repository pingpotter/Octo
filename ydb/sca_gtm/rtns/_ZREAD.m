%ZREAD(DEVICE,ETYP)	;System;Various READ extrinsic functions
	...
	;----- Revision History -----------------------------------------------
	;
	; 10/17/06 - Rick Silvagni (2011-03-11, Frans S.C. Witte, CR53450)
	;	     Added an error trap to halt in PWDET.  This section
	;	     is the error trap for the password which would reset
	;	     ECHO.  If this also fails, it means we no longer have
	;	     a terminal and we should halt out of M.
	;
