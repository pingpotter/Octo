...
*	Date: March 09, 1998
*
*	DESC: MD5 Hash Encryption
*
*   $Id$
*   $Log: scamd5.c,v $
* Revision 1.2 Lian Chen 12/24/98
* Use descriptor struct as arguments
* Provide one way hash function utility for password encryption.
*
* Revision 1.1 Hien Ly 03/09/98
* Use STR_DESCRIPTOR instead of DSCR for string structure.
*
* Revision 1.0 
* Initial Revision
*/
