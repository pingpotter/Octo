 ...
 */
static void parse_header (char *str, int *field_len, int *header_size)
{
	if (*str != 0)
	{
	...
	{
		*header_size = 4;
		*field_len = (unsigned char) str[2] * 256 + (unsigned char) str[3] - 2;
	}
}
