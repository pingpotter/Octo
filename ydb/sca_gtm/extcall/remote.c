...
*	All Rights Reserved
*
*	Author:	Harsha Lakshmikantha
*
*	DESC:	UNIX System calls for Profile
*
*   $Id$
*   $Log:	remote.c,v $
...
void stfstart(int count,char *fep,char *fep_name,SLONG *return_code)
{
...
void stfstop(int count,char *fep,char *fep_name,SLONG *return_code)
{
	RETURNSTATUS 	rc = SUCCESS;
	FILE 		*fd = (FILE *)NULL;
	char 		cmd[MAX_CMD_LEN];
...
void mtmbod(int count,char *fep,char *fep_name,char *date,SLONG *return_code)
{
	RETURNSTATUS 	rc = SUCCESS;
	FILE 		*fd = (FILE *)NULL;
	char 		cmd[MAX_CMD_LEN];
...
void mtmeod(int count,char *fep,char *fep_name,char *uid,char *rd,char *hd,SLONG *return_code)
{
	RETURNSTATUS 	rc = SUCCESS;
	FILE 		*fd = (FILE *)NULL;
	char 		cmd[1000];
...
void clxfr(int count,char *fep,char *fep_name,char *glo,char *glokil,char *mrtns,char *crtns,char *srtns,char *prtns,SLONG *return_code)
{
	RETURNSTATUS 	rc = SUCCESS;
	FILE 		*fd = (FILE *)NULL;
	char 		cmd[1000];
...
void rtnupdat(int count,char *fep,char *fep_name,char *rtnlist,char *cmp,SLONG *return_code)
{
	RETURNSTATUS 	rc = SUCCESS;
	FILE 		*fd = (FILE *)NULL;
	char 		cmd[MAX_CMD_LEN];
...
void feptfile(int count,char *fep,char *fep_name,char *dirnam1,char *rms,SLONG *return_code)
{
	RETURNSTATUS 	rc = SUCCESS;
	FILE 		*fd = (FILE *)NULL;
	char 		cmd[1000];
